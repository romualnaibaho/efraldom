...
<html lang="en">
    ...
    <body id="body2">
        ...
        <div class="container text-center">
            <br><br><br><br>
            <p class="title-bg-2" style="font-size:70px;color:#555555;">Zona Merah</p>
            <hr>
        </div>
            ...
            <div class="row">
                <div id="zone-wrapper">
                    <div id="zone-header" style="margin-top:35px;">
                        <form method="GET" action="/efraldom/public/redzone/search">
                            <br>
                            <div class="row mb-3">
                                <div class="col-sm-5">
                        ...
                        <a href="/efraldom/public/redzone/" style="float:right;color:#d1124b;font-size: 18px;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">reset</a>
